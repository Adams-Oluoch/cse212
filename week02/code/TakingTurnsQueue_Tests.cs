...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue inserts at the front instead of the back, reversing the expected order.
    ...
    // Defect(s) Found: PersonQueue.Enqueue order was incorrect, causing the queue to return the wrong person after George is added.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson did not re-enqueue infinite-turn players, so Tim was removed from the queue.
    ...
    // Defect(s) Found: No defect found; the empty queue exception behavior is correct.
